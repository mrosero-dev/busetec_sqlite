...
async function getDb() {
    ...
    if (fs.existsSync(DB_FILE)) {
        ...
        // Ejecutar schema siempre: los IF NOT EXISTS protegen los datos existentes
        // y crean las tablas nuevas que aún no existan (autobuses, conductores)
        _db.run(SCHEMA);
        persistir();
        console.log('✅ Base de datos cargada y schema actualizado');
    } else {
